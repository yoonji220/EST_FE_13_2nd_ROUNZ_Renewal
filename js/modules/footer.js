        ...
        <div class="footer-wrap">
          <div class="pc-only footer-main-content">
            <div class="d-flex flex-column g-4">
              ...
              <ul class="d-flex g-2">
                <li><a href="#"><img src="./img/footer/footer_1.webp" alt="Facebook"></a></li>
                <li><a href="#"><img src="./img/footer/footer_2.webp" alt="Instagram"></a></li>
                <li><a href="#"><img src="./img/footer/footer_3.webp" alt="Naver Blog"></a></li>
              </ul>
            </div>
